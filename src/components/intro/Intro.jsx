...
// import ME from '../../assets/Tagizade image.jpg';
      ...
      <div className="container about__container">
        <div className="about__me">
          <div className="about__me-image">
            <img src={img} alt="Hitender Yadav" />
          </div>
        </div>
        <div className="about__content">
          ...
          <p>
            1+ years experienced Application Developer with hands-on experience in
            ...
            deploying Flutter concepts. Proficient in translating designs and
            wireframes into high-quality code, and writing application interface
            code via Dart and Flutter workflows. Adept at monitoring and
